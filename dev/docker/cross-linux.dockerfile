...
ENV GCC_${CROSS_COMPILE}="${CROSS_GCC_DIR}/bin/${CROSS_GCC_TRIPLET}-gcc"
ENV GXX_${CROSS_COMPILE}="${CROSS_GCC_DIR}/bin/${CROSS_GCC_TRIPLET}-g++"
ENV CLANG_${CROSS_COMPILE}="/usr/bin/clang"
ENV CLANGXX_${CROSS_COMPILE}="/usr/bin/clang++"
